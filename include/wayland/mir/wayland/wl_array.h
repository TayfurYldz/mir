...
{
public:
    WlArray() noexcept = default;

    explicit WlArray(wl_array const* to_copy) : base{to_copy} {}
    ...
    WlArray(WlArray const&) = default;
    WlArray(WlArray&&) noexcept = default;
    auto operator=(WlArray const&) -> WlArray& = default;
    auto operator=(WlArray&&) noexcept -> WlArray& = default;
    ~WlArray() = default;
    ...
    void append(Iterator begin, Iterator end)
    {
        ...
        auto* dest = static_cast<ValueType*>(base.grow(static_cast<size_t>(count) * sizeof(ValueType)));
        std::copy(begin, end, dest);
    }

    operator wl_array*() { return base; }
    operator wl_array const*() const { return base; }
